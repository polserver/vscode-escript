...
export type Type =
    (type.AllLiteral | type.ArrayType | type.FieldType | type.FunctionType |
     ...
     type.TypeApplication | type.UninitObjectLiteral | type.UnionType | type.FunctionObjectLiteral |
     type.VoidLiteral | type.StringLiteralType | type.NumericLiteralType | type.BooleanLiteralType);
...
export module type {
  ...
  export interface RecordType { type: 'RecordType', base: 'dictionary' | 'error' | 'struct', fields: Type[] }
  ...
  export interface UninitObjectLiteral { type: 'UninitObjectLiteral' }
  export interface UnionType { type: 'UnionType', elements: Type[] }
  export interface FunctionObjectLiteral { type: 'FunctionObjectLiteral' }
